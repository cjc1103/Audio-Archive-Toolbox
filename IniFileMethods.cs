...
namespace AATB
{
    public partial class AATB_Main
    {
        static IniData ReadConfiguration(string ConfigurationFilePath)
        {
            ...
            // Output   configData data structure
        ...
        static string[] ExpandCommandLine(IniData configData, string[] InputCommandLine)
        {
            ...
            //  InputCommandLine    command line input to be expanded
            // Output
            //  ExpandedCommandLineList  string array command line after macro substitution
            ...
            if (InputCommandLine.Length > 0)
            {
                ...
                if (configData != null)
                {
                    ...
                    foreach (string CommandSubstring in InputCommandLine)
                    {
                        ...
                        (arg, opt) = SplitString(CommandSubstring, EQUALS);
                    ...
                    ExpandedCommandLineList = InputCommandLine;
            }
